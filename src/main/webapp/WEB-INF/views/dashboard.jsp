...
<div class="container dashboard-container">
	<div class="row">
		<div class="col-5 pt-5">
			<h3 class="text-dark text-center">Your Messages</h3>
			<div class="d-flex justify-content-center">
            	<div class="input-group p-4 w-md-75 w-lg-50">
                	<input type="text" class="form-control rounded live-search-box regular" placeholder="Search Contacts" aria-label="Search Contacts"
		...
		<div class="col-7 pt-5 text-center bg-dark dashboard-column">
			<h3 class="text-white">Currently Selected</h3>
    ...
    <div id="chat-page" class="fade-in d-flex align-items-center justify-content-center w-100 styled-text text-white">
        <div class="chat-container w-100 w-sm-75 w-lg-62 w-xxl-50 dash-container">
